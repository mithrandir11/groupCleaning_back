...
<div class="container mx-auto px-4" >
    ...
    <form action="{{route('admin.articles.update', $article)}}" method="POST" class="space-y-12" enctype="multipart/form-data">
        ...
        <div>
            ...
            <input type="text" name="seo[title]" id="seo_title" class="border rounded-lg w-full p-3 max-w-sm" value="{{ old('seo.title', $article->seo?->title) }}" >
            @error('seo.title')
                <p class="text-red-600 text-sm ">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <textarea  name="seo[description]" id="seo_description" class="border rounded-lg w-full p-3 max-w-sm">{{ old('seo.description', $article->seo?->description) }}</textarea>
        ...
        <div>
            ...
            <input type="text" name="seo[keywords]" id="seo_keywords" class="border rounded-lg w-full p-3 max-w-sm" value="{{ old('seo.keywords', $article->seo?->keywords) }}" >
            @error('seo.keywords')
                <p class="text-red-600 text-sm ">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="seo[canonical_url]" id="canonical_url" class="border rounded-lg w-full p-3 max-w-sm" value="{{ old('seo.canonical_url', $article->seo?->canonical_url) }}" >
