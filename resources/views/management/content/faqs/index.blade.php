...
<div class="  grow">
    ...
    <div class="flex mb-10">
        <a href="{{route('admin.faqs.create')}}" type="submit" class="flex items-center gap-x-2 text-white bg-green-500 hover:bg-green-600 duration-200 rounded-lg text-sm px-4 py-2 ">
