...
<div class=" overflow-x-auto  grow">
    ...
    <div class="flex">
        <a href="{{route('admin.services.create')}}" type="submit" class="flex items-center gap-x-2 text-white bg-green-500 hover:bg-green-600 duration-200 rounded-lg text-sm px-4 py-2 ">
        ...
        <tbody>
            ...
            <tr class="odd:bg-white  even:bg-gray-50  border-b ">
                ...
                <td class="px-6 py-4 text-center">
                    <a href="{{route('admin.services.edit', $service)}}" class="bg-yellow-100 py-1 px-4 text-black text-xs rounded-full font-semibold transition-all duration-200">
                        ویرایش
                    </a>
