...
<div class="container mx-auto px-4" >
    ...
    <div class="flex justify-between items-center gap-x-3 mb-10 ">
        <h1 class="text-2xl font-bold mb-4 text-right">ایجاد خدمت جدید</h1>
    ...
    <form action="{{route('admin.services.store')}}" method="POST" class="space-y-12" enctype="multipart/form-data">
        @csrf
        <div>
