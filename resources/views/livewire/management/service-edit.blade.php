<div class="grow">
    <h1 class="text-2xl font-bold mb-10 ">ویرایش خدمت</h1>
        ...
        @elseif ($previous_image)
            <img src="{{ $previous_image }}" class="border rounded-lg h-24">
        @endif
{{-- 
        @if ($previous_image) 
            <img src="{{ $previous_image }}" class="border rounded-lg">
        @endif --}}
        <div wire:loading wire:target="image" class="text-xs">در حال آپلود تصویر ...</div>

        <!-- نوع خدمت -->
        <div class="my-16 border-y border-dashed py-6 border-gray-300">
                ...
                @foreach ($type['values'] as $index => $value)
                    <div class="flex items-center mb-4">
                        ...
                        <button wire:click.prevent="removeTypeValue({{ $index }})"
                                class="mr-2 px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 focus:outline-none">
                ...
                <div class="border bg-gray-50 rounded-lg p-4 mb-6">
                    ...
                    <div>
                        ...
                        <button wire:click.prevent="removeOption({{ $index }})"
                                class="px-4 py-2 text-sm bg-red-500 text-white rounded-lg hover:bg-red-600 focus:outline-none mt-2">
                            حذف گزینه
                        </button>
                    </div>
                </div>
