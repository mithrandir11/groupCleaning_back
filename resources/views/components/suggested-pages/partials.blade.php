  ...
  @foreach($menus as $menu)
      <li class="mb-6">
          <div class="flex items-center justify-between">
              ...
              <div>
                  <a href="{{route('admin.suggestedPages.show', $menu)}}"  type="button" class="bg-blue-100 py-1 px-4 text-black text-xs rounded-full font-semibold transition-all duration-200 ml-2 inline-flex gap-x-1">
          ...
          @if($menu->children && $menu->children->isNotEmpty())
              <div class="mr-4 border-r border-gray-300 pr-4 mt-6">
                  <x-suggested-pages.partials :menus="$menu->children"/>
              </div>
          @endif
      </li>
  @endforeach
