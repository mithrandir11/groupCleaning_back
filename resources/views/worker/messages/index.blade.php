...
<div class="grow">
    <div style="height: 40rem" class="ltr overflow-y-auto w-full flex flex-col-reverse  border p-4 lg:p-8 rounded-lg">
        ...
        <div class="grid ">
            <div class="flex gap-2.5 mb-4">
                ...
                <div class="grid">
                    <h5 class="text-gray-900 text-sm font-semibold leading-snug pb-1">مدیریت</h5>
    ...
    <form action="{{route('worker.messages.store')}}" method="POST" class=" w-full pr-3 pl-2 py-2 mt-3 rounded-lg border border-gray-200 items-center gap-2 inline-flex justify-between">
        @csrf
